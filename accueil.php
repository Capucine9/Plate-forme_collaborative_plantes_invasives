...
<div class= "carre">
    ...
    <p style="text-indent:20px" align="justify">L'objectif de cette plate-forme est de sensibiliser ses utilisateurs aux
    dangers des plantes envahissantes. Cette page web est une plate-forme collaborative qui permet 
    ...
    Les plantes indigènes sont originaires du milieu où elles sont implantées; tandis que les 
    ...
    du nombre de plantes indigènes. En effet, elles sont la deuxième cause de perte de biodiversité
    dans le monde. Elles peuvent avoir une capacité de reproduction supérieure aux espèces présentes
    dans la zone et les surpasser en nombre ou éliminer les autres plantes. Cela aura alors des
    répercussions sur les espèces animales présentes sur le site. Certaines espèces végétales comme
    ...
    <p style="text-indent:20px">Certaines plantes ont des effets néfastes sur la santé humaine.
    Par exemple, l'ambroisie à feuilles d'armoise est particulièrement allergène, 10% de la
    population française y serait sensible. Il y a également la berce du Caucase qui peut
    provoquer des brûlures avec sa sève.</br></br>
    </p>
    
    <li align="justify"><b>Economique</b></br>
    <p style="text-indent:20px">Les plantes invasives peuvent provoquer la dégradation de diverses
    infrastructures comme les routes qui sont altérées par la repousse de certaines espèces comme l'ailante.
    Les réparations vont alors être coûteuses. De plus, les espèces invasives peuvent également
    se développer sur des espaces dédiés à la culture agricole, ce qui va diminuer les récoltes
    et donc diminuer les rendements de l'agriculteur.</br>
    Finalement, l'éradication de ces plantes est onéreux car elles sont difficiles à contrôler
    et à éliminer.</br>
    </p></p>
    ...
    nuisibles. La pioche, la tronçonneuse ou encore la débroussailleuse sont fréquemment utilisées.
    Mais cela dépend des régions, par exemple, à la Réunion l'outil le plus répandu est le sabre.
    Ces instruments permettent de tailler les plantes avant la floraison, ainsi elles ne pourront pas
    disperser leur pollen et donc se reproduire. Mais ils permettent aussi de les déraciner ou encore de les tuer.
    </br></br>
    </p>
    ...
    C'est la technique la moins exploitée car elle tasse le sol et doit donc être pratiquée sur des milieux
    peu sensibles où il y a une densité assez importante de plantes envahissantes.
    </br></br>
    </p>
    ...
    les ans une liste des produits chimiques autorisés. Mais depuis 2018, l'ONF a mis fin à
    l'utilisation de ces substances toxiques. Désormais les méthodes mécanisées et des techniques
