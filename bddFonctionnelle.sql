...
--
-- Host: localhost:3308
-- Generation Time: Mar 26, 2022 at 04:01 PM
...
(1, 4, 1, 'test', 'test', '2022-03-23', 'test', ''),
(2, 3, 2, 'Test', NULL, '2022-03-22', '', NULL),
(3, 5, 1, 'Test', NULL, '2022-03-19', 'test', NULL),
(4, NULL, 1, 'Test', NULL, '2022-03-09', 'test', NULL),
(5, NULL, 1, 'Test', NULL, '2022-03-19', '', NULL),
(6, NULL, 1, 'Limoges', NULL, '2022-03-25', '', NULL),
(7, 1, 1, 'Limoges', NULL, '2022-03-26', 'test id  utilisateur connecté', NULL);
...
(1, 'lecreateurdusite@test.fr', '$2y$10$3vN1MEzZezDh8PUrtr08XuxhUNObood21KJYZEjvoFHD28fpx.DXu', 'LeCreateurDuSite', 3, 0, NULL, 'profil.jpg', 0),
(3, 'clairemorin49@hotmail.com', '$2y$10$qPPV3.yuRHHJT3ufeLAxmeRosIO.FrGcXlW.O0cdA81eKM3zMl2Zi', 'Claire', 1, 0, NULL, 'profil.jpg', 0),
(4, 'clairemorin05@gmail.com', '$2y$10$zc/B.dL..iHGRyMM5DRd1ukIkpPefZEo8lZYji6GG871GvaM98koi', 't', 1, 0, NULL, 'profil.jpg', 0),
(5, 'test', '$2y$10$WK9N35OK/wOAZxedwRMd4eiVZYUyzlIHJLAw5Benv96rWJNyynLde', 't', 1, 0, NULL, 'profil.jpg', 0),
(6, 'ssssssssssssss', '$2y$10$tuOGHr6frKTjmeeW/lDZResieiItiGljM7rjTRN10hz6P8iOgGQ8m', 't', 1, 0, NULL, 'profil.jpg', 0);
...
--
ALTER TABLE `plantes`
  MODIFY `Id_plante` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;

--
-- AUTO_INCREMENT for table `signalements`
--
ALTER TABLE `signalements`
  MODIFY `Id_signalement` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
