...
--
-- Host: localhost:3308
-- Generation Time: Apr 07, 2022 at 07:55 AM
...
CREATE TABLE `plantes` (
  ...
  `Couleur_fleur` enum('Jaune','Rouge','Vert','Violet','Bleu','Marron','Blanc','Rose','Orange','Gris','Noir') DEFAULT NULL,
  `Couleur_fruit` enum('Jaune','Orange','Rouge','Bleu','Violet','Vert','Gris','Noir','Blanc','Rose','Marron') DEFAULT NULL,
  `Régions` varchar(1000) DEFAULT NULL,
  `Photos` varchar(1000) DEFAULT NULL,
  `Details` varchar(1000) DEFAULT NULL,
  `Famille` enum('Arbre','Arbuste','Plante','Algue') NOT NULL,
  `Période_floraison` enum('Printemps','Ete','Automne','Hiver') DEFAULT NULL,
  `Période_fructification` enum('Printemps','Ete','Automne','Hiver') DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `signalements` (`Id_signalement`, `Id_utilisateur`, `Id_plante`, `Ville`, `Coordonnees_GPS`, `Date_signalement`, `Commentaire`, `Photos`, `Verifier`) VALUES
(1, 4, 1, 'test', 'test', '2022-03-23', 'test', '', 1),
(2, 3, 2, 'Test', NULL, '2022-03-22', '', NULL, 1),
(4, NULL, 1, 'Test', NULL, '2022-03-09', 'test', NULL, 0),
(5, NULL, 1, 'Test', NULL, '2022-03-19', '', NULL, 0),
(6, NULL, 1, 'Limoges', NULL, '2022-03-25', '', NULL, 0),
(7, 1, 1, 'Limoges', NULL, '2022-03-26', 'test id  utilisateur connecté', NULL, 1),
(8, NULL, 1, 'Test', NULL, '2022-03-30', 'test', NULL, 0),
(9, 1, 1, 'Test', NULL, '2022-03-30', '', NULL, 0),
(10, 1, 1, 'Test', NULL, '2022-03-31', 'ajout avec verif', NULL, 0);
...
(1, 'lecreateurdusite@test.fr', '$2y$10$3vN1MEzZezDh8PUrtr08XuxhUNObood21KJYZEjvoFHD28fpx.DXu', 'LeCreateurDuSite', 3, 0, NULL, 'profil.jpg', 10),
(3, 'clairemorin49@hotmail.com', '$2y$10$qPPV3.yuRHHJT3ufeLAxmeRosIO.FrGcXlW.O0cdA81eKM3zMl2Zi', 'Claire', 1, 0, NULL, 'profil.jpg', 1),
(4, 'clairemorin05@gmail.com', '$2y$10$zc/B.dL..iHGRyMM5DRd1ukIkpPefZEo8lZYji6GG871GvaM98koi', 't', 2, 0, NULL, 'profil.jpg', 6),
(5, 'test', '$2y$10$WK9N35OK/wOAZxedwRMd4eiVZYUyzlIHJLAw5Benv96rWJNyynLde', 't', 1, 0, NULL, 'profil.jpg', 0),
(6, 'ssssssssssssss', '$2y$10$tuOGHr6frKTjmeeW/lDZResieiItiGljM7rjTRN10hz6P8iOgGQ8m', 't', 1, 1, NULL, 'profil.jpg', 0),
(7, 'clairemorin49@hotmail.fr', '$2y$10$My.GAo2yCzEp47ql6CTYyObNisokXVUJYVIW0VvzT/V6uI6EHDTW2', 'claire', 1, 0, NULL, 'profil.jpg', 0);
...
--
ALTER TABLE `signalements`
  MODIFY `Id_signalement` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `utilisateurs`
--
ALTER TABLE `utilisateurs`
  MODIFY `Id_utilisateur` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
COMMIT;
